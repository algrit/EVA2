...
urlpatterns = [
    ...
    path('my/<int:pk_course_sub>/<int:pk_test>/', views.start_test_warning, name='start_test_warning'),  # name is used in course_detail.html
    path('my/create_attempt/<int:pk_course_sub>/<int:pk_test>/', views.test_att_create, name='test_att_create'),  # name is used in course_detail.html
    path('my/attempt/<int:pk_test_attempt>/', views.test_attempt, name='test_attempt'),  # name is used in view.test_att_create
    path('my/attempt/result/<int:pk_test_attempt>/', views.test_att_result, name='test_result'),  # name is used in view.test_attempt
]